...
namespace App\UtilModel\Configs;
    ...
    public function makeModel($table) {
        ...
        foreach($list_table as $table) {
            ...
            if($orm->hasTable($table)) {
                $template = file_get_contents(base_path("app/UtilModel/Stubs/Model.php.stub"));
                ...
                file_put_contents(base_path("app/UtilModel/Models/".$model_name.".php"), $template);

                print "Model table `".$table."` has been created -> /app/UtilModel/Models/".$model_name.".php\n";
            } else {
